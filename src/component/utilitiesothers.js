...
export default function UtilitiesOthers(){
...
<ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li className="nav-item active">
        <a className="nav-link" href="#" data-toggle="collapse" data-target="#collapseUtilities"
        ...
        <div id="collapseUtilities" className="collapse show" aria-labelledby="headingUtilities"
            ...
            <div className="bg-white py-2 collapse-inner rounded">
                ...
                <a className="collapse-item active" href="utilities-other.html">Other</a>
            </div>
        </div>
    </li>
